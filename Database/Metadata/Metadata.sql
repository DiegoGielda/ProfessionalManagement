...
CREATE TABLE FINANCIAL_ACCOUNT (
    ...
    VALUE_ACCOUNT           VALUE_FINANCIAL DEFAULT 0.00 NOT NULL,
    LOG_DATE_INSERT_RECORD  TIMESTAMP default current_timestamp NOT NULL,
    LOG_DATE_UPDATE_RECORD  TIMESTAMP default current_timestamp NOT NULL
);
...
ALTER TABLE RECORD_SHEET_TIME ADD CONSTRAINT FK_REC_SHEET_TIME_RECORD_SHEET FOREIGN KEY (CD_RECORD_SHEET) REFERENCES RECORD_SHEET (ID_RECORD_SHEET);
