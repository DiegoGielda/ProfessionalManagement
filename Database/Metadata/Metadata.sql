...
CREATE GENERATOR GEN_ATTACHMENT_DETACHED;
CREATE GENERATOR GEN_ATTACHMENT_DETACHED_GROUP;
CREATE GENERATOR GEN_CARD_INVOICE;
...
CREATE TABLE ATTACHMENT_DETACHED (
    ID_ATTACHMENT_DETACHED        INTEGER NOT NULL,
    CD_ATTACHMENT_DETACHED_GROUP  INTEGER NOT NULL,
    ATTACHMENT_DETACHED           BLOB SUB_TYPE 0 SEGMENT SIZE 500,
    ATTACHMENT_DETACHED_NAME      VARCHAR(255) NOT NULL,
    ASSIGNED                      LOGICAL NOT NULL,
    LOG_DATE_INSERT_RECORD        TIMESTAMP DEFAULT current_timestamp NOT NULL,
    LOG_DATE_UPDATE_RECORD        TIMESTAMP DEFAULT current_timestamp NOT NULL
);

CREATE TABLE ATTACHMENT_DETACHED_GROUP (
    ID_ATTACHMENT_DETACHED_GROUP  INTEGER NOT NULL,
    DESCRIPTION                   VARCHAR(100) NOT NULL,
    PATH_GROUP                    VARCHAR(100) NOT NULL,
    LOG_DATE_INSERT_RECORD        TIMESTAMP DEFAULT current_timestamp NOT NULL,
    LOG_DATE_UPDATE_RECORD        TIMESTAMP DEFAULT current_timestamp NOT NULL
);

CREATE TABLE CARD_INVOICE (
    ID_CARD_INVOICE           INTEGER NOT NULL,
    CD_FINANCIAL_INSTITUTION  INTEGER NOT NULL,
    DESCRIPTION               VARCHAR(255) NOT NULL,
    DATE_OPENING              DATE NOT NULL,
    DATE_CLOSURE              DATE NOT NULL,
    DATE_PAYMENT              DATE NOT NULL,
    ACTIVE_RECORD             LOGICAL NOT NULL,
    LOG_DATE_INSERT_RECORD    TIMESTAMP DEFAULT current_timestamp NOT NULL,
    LOG_DATE_UPDATE_RECORD    TIMESTAMP DEFAULT current_timestamp NOT NULL
);
...
ALTER TABLE ATTACHMENT_DETACHED ADD CONSTRAINT PK_ATTACHMENT_DETACHED PRIMARY KEY (ID_ATTACHMENT_DETACHED);
ALTER TABLE ATTACHMENT_DETACHED_GROUP ADD CONSTRAINT PK_ATTACHMENT_DETACHED_GROUP PRIMARY KEY (ID_ATTACHMENT_DETACHED_GROUP);
ALTER TABLE CARD_INVOICE ADD CONSTRAINT PK_ID_CARD_INVOICE PRIMARY KEY (ID_CARD_INVOICE);
...
ALTER TABLE ATTACHMENT_DETACHED ADD CONSTRAINT FK_ATTA_DETACHED_ATTA_GROUP FOREIGN KEY (CD_ATTACHMENT_DETACHED_GROUP) REFERENCES ATTACHMENT_DETACHED_GROUP (ID_ATTACHMENT_DETACHED_GROUP);
ALTER TABLE CARD_INVOICE ADD CONSTRAINT FK_CARD_INVOICE_FIN_INSTITUTION FOREIGN KEY (CD_FINANCIAL_INSTITUTION) REFERENCES FINANCIAL_INSTITUTION (ID_FINANCIAL_INSTITUTION);
...
ALTER TABLE FINANCIAL_ACCOUNT ADD CONSTRAINT FK_FIN_ACCOUNT_CARD_INVOICE FOREIGN KEY (CD_CARD_INVOICE) REFERENCES CARD_INVOICE (ID_CARD_INVOICE);
...
/* Trigger: TBIU_ATTACHMENT_DETACHED */
CREATE TRIGGER TBIU_ATTACHMENT_DETACHED FOR ATTACHMENT_DETACHED
...
/* Trigger: TBIU_ATTACHMENT_DETACHED_GROUP */
CREATE TRIGGER TBIU_ATTACHMENT_DETACHED_GROUP FOR ATTACHMENT_DETACHED_GROUP
ACTIVE BEFORE INSERT OR UPDATE POSITION 1
as
begin
  if (inserting) then
...
/* Trigger: TBIU_CARD_INVOICE */
CREATE TRIGGER TBIU_CARD_INVOICE FOR CARD_INVOICE
ACTIVE BEFORE INSERT OR UPDATE POSITION 0
as
begin
  if (inserting) then
...
/* Trigger: TBI_ATTACHMENT_DETACHED */
CREATE TRIGGER TBI_ATTACHMENT_DETACHED FOR ATTACHMENT_DETACHED
ACTIVE BEFORE INSERT POSITION 0
as
begin
  if (new.ID_ATTACHMENT_DETACHED is null) then
  begin
    new.ID_ATTACHMENT_DETACHED = gen_id(GEN_ATTACHMENT_DETACHED, 1);
  end
end
^

/* Trigger: TBI_ATTACHMENT_DETACHED_GROUP */
CREATE TRIGGER TBI_ATTACHMENT_DETACHED_GROUP FOR ATTACHMENT_DETACHED_GROUP
ACTIVE BEFORE INSERT POSITION 0
as
begin
  if (new.ID_ATTACHMENT_DETACHED_GROUP is null) then
  begin
    new.ID_ATTACHMENT_DETACHED_GROUP = gen_id(GEN_ATTACHMENT_DETACHED_GROUP, 1);
  end
end
^

/* Trigger: TBI_CARD_INVOICE */
CREATE TRIGGER TBI_CARD_INVOICE FOR CARD_INVOICE
ACTIVE BEFORE INSERT POSITION 0
as
begin
  if (new.ID_CARD_INVOICE is null) then
  begin
    new.ID_CARD_INVOICE = gen_id(GEN_CARD_INVOICE, 1);
  end
end
^
